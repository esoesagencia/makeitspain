...
// ─── Default AI prompt (external AI → MAKEITSPAIN PLAN format) ───────────────
...
function PromptModal({ text, copied, onChange, onCopy, onReset, onClose }: {
  text: string;
  copied: boolean;
    ...
    >
      ...
      >
        ...
        <div className="flex-1 overflow-hidden p-4">
          <textarea
            className="w-full h-full resize-none outline-none rounded-xl p-3 text-[12px] leading-relaxed font-mono"
            style={{ background: "rgba(245,237,237,0.4)", border: "1px solid rgba(180,100,90,0.15)", color: "#1E0E0B", minHeight: "420px" }}
            value={text}
